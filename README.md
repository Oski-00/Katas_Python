 ![image](https://github.com/user-attachments/assets/ed95f534-9e6e-4ed6-bf03-1dc91c3a4183)
...
# Para la pregunta número 36 en la que se nos pregunta un caso de uso en el que tenemos que realizar varias operaciones de retiro de dinero, transferencia y agragar dinero a un usuario, hemos incluido
# un importe mayor al indicado en el enunciado, para que pudiéramos verificar el resto de soluciones planteadas a las siguientes preguntas. Si se quiere observar el error dado, simplemente hay que indicar el 
# importe señalado en el enunciado.

# 2. DESCRIPCIÓN DEL PROYECTO

Como comentado, el proyecto se ha estructurado en la resolución de varias preguntas para poner en práctica lo visto en clase. La estructura del proyecto y las herramientas utilizadas para la realización de este proyecto han sido:

|-- Pdf con las preguntas.

|-- Visual Studio Code para dar respuesta a las preguntas.

|-- Se proporciona archivo Readme con el resumen del proyecto.

# 3. INSTALACIÓN Y REQUISITOS

Para dar respuesta a todas las preguntas se ha utilizado el programa Visual Studio Code, al cual se le han instalado las siguientes extenciones:
...
Las preguntas indicadas para resolver, no tienen correspondencia entre ellas ni están relacionadas unas con otras, son preguntas individuales en donde se plantean diferentes problemas a resolver,
por lo que los resultados son independientes entre ellos y no podríamos buscar una relación entre los mismos. Lo que podríamos indicar sobre los resultados de los mismos es que he intentado respondeer de la manera más eficiente 
y práctica posible, así como intentar organizar el código de la manera más legible posible.

# 5. SIGUIENTES PASOS A REALIZAR

Los siguientes pasos a realizar este proyecto serían realizar las posibles correcciones que pudieran plantearme para mejorar los resultados obtenidos.

# 6. Autor.

Óscar Pérez Chico

Oski-00 / Katas_Python
